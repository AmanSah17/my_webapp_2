...
work = Image.open("D:\My_webapp\images\work.jpg")
project = Image.open("D:\My_webapp\images\projects.jpg")
...
with st.container():
    ...
    with p:
        st.image(linkedin,caption="[Linkedin Profile](https://www.linkedin.com/in/aman-sah-8a320b14b/)",width=150)
    with q:
        st.image(github,caption="[Github Profile ](https://github.com/AmanSah17)",width=50)
    with r:
        st.image(project,caption="[Projects](2_Projects.py)",width=50)
    with s:
        st.image(work,caption="[Experiences](1_Internships.py)",width=50)
    st.write("---")
